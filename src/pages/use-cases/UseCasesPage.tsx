...
function UseCasesPage() {
  ...
  const features = [
    {
      titleKey: "main.features.customSchemas.title",
      descriptionKey: "main.features.customSchemas.description",
    },
    {
      titleKey: "main.features.anyProvider.title",
      descriptionKey: "main.features.anyProvider.description",
    },
    {
      titleKey: "main.features.validatedOutput.title",
      descriptionKey: "main.features.validatedOutput.description",
    },
    {
      titleKey: "main.features.apiFirst.title",
      descriptionKey: "main.features.apiFirst.description",
    },
  ];
