      ...
      <div className="text-center mb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto mt-6">
          <div className="bg-theme-bg-secondary rounded-lg p-4">
            ...
            <div className="text-sm text-theme-text-tertiary">{t('quickStats.codeSplitting')}</div>
          </div>
          <div className="bg-theme-bg-secondary rounded-lg p-4">
            <div className="text-lg font-semibold text-blue-600 dark:text-blue-400 mb-1">
              {t('quickStats.serviceWorker')}
            </div>
            <div className="text-sm text-theme-text-tertiary">{t('quickStats.offlineCache')}</div>
          </div>
          <div className="bg-theme-bg-secondary rounded-lg p-4">
            <div className="text-lg font-semibold text-purple-600 dark:text-purple-400 mb-1">
              {t('quickStats.preloading')}
            </div>
            <div className="text-sm text-theme-text-tertiary">{t('quickStats.routePrefetch')}</div>
          </div>
          <div className="bg-theme-bg-secondary rounded-lg p-4">
            <div className="text-lg font-semibold text-orange-600 dark:text-orange-400 mb-1">
              &lt; 2.5s
            </div>
            <div className="text-sm text-theme-text-tertiary">{t('quickStats.lcpTarget')}</div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-theme-bg-primary border border-theme-border rounded-xl overflow-hidden">
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="flex items-center justify-between p-3 rounded-lg border border-theme-border">
              <div>
                <h4 className="font-medium text-theme-text-primary">{t('webVitals.lcp.title')}</h4>
                <p className="text-sm text-theme-text-tertiary">{t('webVitals.lcp.description')}</p>
              </div>
            ...
            <div className="flex items-center justify-between p-3 rounded-lg border border-theme-border">
              <div>
                <h4 className="font-medium text-theme-text-primary">{t('webVitals.fid.title')}</h4>
                <p className="text-sm text-theme-text-tertiary">{t('webVitals.fid.description')}</p>
              </div>
            ...
            <div className="flex items-center justify-between p-3 rounded-lg border border-theme-border">
              <div>
                <h4 className="font-medium text-theme-text-primary">{t('webVitals.cls.title')}</h4>
                <p className="text-sm text-theme-text-tertiary">{t('webVitals.cls.description')}</p>
              </div>
...
CLS: < 0.1 (good), < 0.25 (needs improvement)`}
        ...
        <div className="bg-theme-bg-primary border border-theme-border rounded-xl overflow-hidden">
          ...
          <div className="p-6 space-y-4">
            <div>
              <h4 className="font-medium text-theme-text-primary mb-3">{t('bundle.lazyLoadingStates')}</h4>
            ...
            <div>
              <h4 className="font-medium text-theme-text-primary mb-3">{t('bundle.bundleAnalysis')}</h4>
              <div className="grid grid-cols-2 gap-2 text-sm">
                <div className="p-2 bg-green-100 dark:bg-green-900/20 rounded">
                  <span className="font-medium">{t('bundle.react')}</span> ~207KB
                </div>
                <div className="p-2 bg-blue-100 dark:bg-blue-900/20 rounded">
                  <span className="font-medium">{t('bundle.firebase')}</span> ~161KB
                </div>
                <div className="p-2 bg-purple-100 dark:bg-purple-900/20 rounded">
                  <span className="font-medium">{t('bundle.uiComponents')}</span> ~219KB
                </div>
                <div className="p-2 bg-orange-100 dark:bg-orange-900/20 rounded">
                  <span className="font-medium">{t('bundle.charts')}</span> ~368KB
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="bg-theme-bg-primary border border-theme-border rounded-xl overflow-hidden">
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h4 className="font-medium text-theme-text-primary mb-3">{t('api.currentLatency')}</h4>
              <div className="space-y-3">
                <div className={`p-3 rounded ${apiLatency < 200 ? 'bg-green-50 dark:bg-green-900/20' : apiLatency < 400 ? 'bg-yellow-50 dark:bg-yellow-900/20' : 'bg-red-50 dark:bg-red-900/20'}`}>
                  <div className="flex items-center justify-between">
                    <span className="text-theme-text-primary">{t('api.averageResponseTime')}</span>
                    <span className="font-medium">{Math.round(apiLatency)}ms</span>
                  </div>
                </div>
              </div>

              <h4 className="font-medium text-theme-text-primary mb-3 mt-6">{t('api.cacheStatus')}</h4>
              <div className="space-y-2">
                <div className="p-3 rounded bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800">
                  <span className="text-green-700 dark:text-green-300 font-medium">{t('api.freshData')}</span>
                  <span className="text-green-600 dark:text-green-400"> - {t('api.recentlyFetched')}</span>
                </div>
                <div className="p-3 rounded bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800">
                  <span className="text-yellow-700 dark:text-yellow-300 font-medium">{t('api.staleData')}</span>
                  <span className="text-yellow-600 dark:text-yellow-400"> - {t('api.needsRefresh')}</span>
                </div>
              </div>
            </div>

            <div>
              <h4 className="font-medium text-theme-text-primary mb-3">{t('api.cachingStrategy')}</h4>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-theme-text-secondary">{t('bestPractices.do.codeSplitting')}</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="text-theme-text-secondary">{t('bestPractices.do.lazyLoading')}</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="text-theme-text-secondary">{t('bestPractices.do.cacheApi')}</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="text-theme-text-secondary">{t('bestPractices.do.preloadRoutes')}</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="text-theme-text-secondary">{t('bestPractices.do.monitorVitals')}</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="text-theme-text-secondary">{t('bestPractices.do.serviceWorker')}</span>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-theme-text-secondary">{t('bestPractices.avoid.eagerLoading')}</span>
                </li>
                <li className="flex items-start gap-2">
                  <AlertTriangle className="h-4 w-4 text-red-500 mt-0.5 flex-shrink-0" />
                  <span className="text-theme-text-secondary">{t('bestPractices.avoid.redundantCalls')}</span>
                </li>
                <li className="flex items-start gap-2">
                  <AlertTriangle className="h-4 w-4 text-red-500 mt-0.5 flex-shrink-0" />
                  <span className="text-theme-text-secondary">{t('bestPractices.avoid.layoutShifts')}</span>
                </li>
                <li className="flex items-start gap-2">
                  <AlertTriangle className="h-4 w-4 text-red-500 mt-0.5 flex-shrink-0" />
                  <span className="text-theme-text-secondary">{t('bestPractices.avoid.blockingRender')}</span>
                </li>
                <li className="flex items-start gap-2">
                  <AlertTriangle className="h-4 w-4 text-red-500 mt-0.5 flex-shrink-0" />
                  <span className="text-theme-text-secondary">{t('bestPractices.avoid.ignoreNetwork')}</span>
                </li>
                <li className="flex items-start gap-2">
                  <AlertTriangle className="h-4 w-4 text-red-500 mt-0.5 flex-shrink-0" />
                  <span className="text-theme-text-secondary">{t('bestPractices.avoid.noTreeShaking')}</span>
                </li>
              </ul>
            </div>
          </div>
