  ...
  return (
    <div>
      <div className="relative flex items-center group">
        ...
        >
          <span className={`flex-shrink-0 ${isSelected && !selectedChildId ? 'text-blue-600 dark:text-blue-400' : 'text-gray-500 dark:text-gray-400'}`}>
            {icon}
          </span>
...
export function DashboardMasterList({ projects, keys, onNavigate }: DashboardMasterListProps) {
