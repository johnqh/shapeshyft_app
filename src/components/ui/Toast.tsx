...
import type { Toast as ToastType, ToastType as ToastVariant } from '../../context/toastContextDef';
...
function Toast({ toast, onDismiss }: ToastProps) {
  ...
  return (
    <div
      ...
      role="alert"
    >
      <span className={`shrink-0 ${iconStyles[toast.type]}`}>{icons[toast.type]}</span>
