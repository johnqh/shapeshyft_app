  ...
  return (
    <div className="space-y-4">
      ...
      <button
        ...
        disabled={loading}
        className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-theme-border rounded-lg hover:bg-theme-hover-bg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      >
