...
export function AISearchOptimization({
  ...
  const knowledgeGraphData = {
    ...
    operatingSystem: "Web",
    description: `${CONSTANTS.APP_NAME} transforms unstructured LLM outputs into reliable, type-safe REST APIs using JSON Schema validation. Works with OpenAI, Anthropic Claude, Google Gemini, and custom LM servers.`,
    url: BASE_URL,
    creator: {
      "@type": "Organization",
      name: "Sudobility",
  ...
  const aiMetaTags = [
    ...
    },
    {
      name: "ai-topics",
      content:
        "structured output, LLM API, JSON Schema validation, AI integration, developer tools",
    },
    {
      name: "ai-sentiment",
      content: "informative, technical, developer-focused",
    },
  ...
  return (
    <Helmet>
      ...
      <script type="application/ld+json">
        {JSON.stringify(knowledgeGraphData)}
      </script>
      ...
      <meta
        itemProp="name"
        content={`${CONSTANTS.APP_NAME} - Structured LLM Output Platform`}
      />
